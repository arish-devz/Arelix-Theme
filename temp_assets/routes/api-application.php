...
/*
|--------------------------------------------------------------------------
| License Controller Routes
|--------------------------------------------------------------------------
|
| Endpoint: /api/application/license
|
*/
Route::group(['prefix' => '/license'], function () {
    Route::post('/verify', [Application\LicenseController::class, 'verify'])
        ->middleware('throttle:60,1') // 60 requests per minute
        ->name('api.application.license.verify');
    Route::get('/status', [Application\LicenseController::class, 'status'])->name('api.application.license.status');
    Route::get('/clear-cache', [Application\LicenseController::class, 'clearCache'])->name('api.application.license.clear-cache');
    Route::get('/clear-addons-cache', [Application\LicenseController::class, 'clearAddonsCache'])->name('api.application.license.clear-addons-cache');
    Route::get('/clear-all-cache', [Application\LicenseController::class, 'clearAllCache'])->name('api.application.license.clear-all-cache');
});
