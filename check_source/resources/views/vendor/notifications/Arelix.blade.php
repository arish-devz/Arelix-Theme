...
$colors = [
    'primary' => !empty($emailColors['primary']) ? $emailColors['primary'] : ($variables['--arelix-primary'] ?? '#df3050'),
    'accent' => !empty($emailColors['primary']) ? $emailColors['primary'] : ($variables['--arelix-accent'] ?? $variables['--arelix-primary'] ?? '#df3050'), // default to primary
    'background' => !empty($emailColors['background']) ? $emailColors['background'] : ($variables['--arelix-background'] ?? '#0c0a09'),
    'card' => !empty($emailColors['card']) ? $emailColors['card'] : ($variables['--arelix-card'] ?? '#1c1917'),
    'text_primary' => !empty($emailColors['text_primary']) ? $emailColors['text_primary'] : ($variables['--arelix-text-primary'] ?? '#ffffff'),
    'text_secondary' => !empty($emailColors['text_secondary']) ? $emailColors['text_secondary'] : ($variables['--arelix-text-secondary'] ?? '#fafafa'),
    'text_muted' => !empty($emailColors['text_muted']) ? $emailColors['text_muted'] : ($variables['--arelix-text-muted'] ?? '#a1a1aa'),
    'border' => !empty($emailColors['border']) ? $emailColors['border'] : ($variables['--arelix-secondary'] ?? '#27272a'),
    'font_family' => $variables['--arelix-font-family'] ?? "'Poppins', sans-serif",
    'font_url' => $variables['--arelix-font-url'] ?? "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap",
];
...
$ownerName = $copyright['ownerName'] ?? 'Arelix';
